...
public class Fibonacci {
	...
	/**
	 * Rekursiivinen ratkaisu on yksikertainen, mutta tehoton. Algoritmi ratkoo
	 * saman ongelman moneen kertaan, kuten seuraavasta k�y ilmi:
	 * 
	 * <pre>
	 *                                   fibo(50)
	 *                 fibo(48)              +               fibo(49)
	...
	/**
	 * Iteratiivinen ratkaisu ei ole yht� selv�, mutta se on tehokas. Metodi
	 * laskee luvun F(50) silm�nr�p�yksess�, kun rekursiivisen metodin
	 * suorituksen aikana ehtii hyvin juoda kahvit.
	 * 
	 * @param n
	 * @return
	 */

...
public class LinjaAuto {
	...
	public int vapaitaPaikkoja() {
		return paikat - matkustajat;
	}

	/**
	 * @return matkustajien lukumaara
	 */
	public int matkustajienMaara() {
		return matkustajat;
	}

	/**
	 * @param maara
	 *            montako matkustajaa lisataan
	 */
	public void lisaa(int maara) {
		int vapaata = vapaitaPaikkoja();
		if (maara > vapaata) {
			System.out.println(maara + " matkustajaa ei mahdu kyytiin. Vain "
					+ vapaata + " vapaata paikkaa.");
		} else {
			matkustajat += maara;
		}
	}
	...
	/**
	 * @param maara
	 *            montako matkustajaa vahennetaan
	 */
	public void vahenna(int maara) {
		...
		if (kyydissa == 0) {
			...
			System.out.println(maara + " matkustajaa ei voi poistua. Vain "
					+ kyydissa + " autossa.");
		} else {
			matkustajat -= maara;
		}
